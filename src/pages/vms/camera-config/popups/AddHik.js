...
const Add = ({
  ...
  return (
    <Dialog
      open={open}
      onClose={loadingOnvif ? null : onClose}
      disableEscapeKeyDown={loadingOnvif}
      fullWidth
      maxWidth='xl'
      style={{ maxWidth: '80%', margin: 'auto' }}
    >
      <DialogTitle style={{ fontSize: '16px', fontWeight: 'bold' }}>Scan Camera  - {selectedTitle}</DialogTitle>
      <DialogContent>
      ...
      <DialogActions>
        <Button onClick={onClose} disabled={loadingOnvif} variant='contained'>
          Cancel
        </Button>
      </DialogActions>
    </Dialog>
