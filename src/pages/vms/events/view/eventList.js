...
import { Box, Button, Card, CardHeader, Chip, Dialog, DialogActions, DialogContent, Grid, IconButton, Menu, MenuItem, Pagination, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography } from "@mui/material"
...
const EventList = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            renderCell: value => (
                <Chip label={value} color={eventTypeColors[value]} />
            )
        },
        {
            id: 3,
    ...
    return (
        <>
            ...
            {isOpenEdit && (
                <Add show={isOpenEdit} onClose={() => setIsOpenEdit(false)} data={eventDetail} setReload={() => setReload(reload + 1)} />
            )}
