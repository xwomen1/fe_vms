  ...
  return (
    <Card>
      ...
      <TableContainer component={Paper}>
        <Table stickyHeader aria-label='sticky table' style={{ minWidth: '300px' }}>
          <TableHead>
            <TableRow>
              ...
              <TableCell align='center' colSpan={9} sx={{ border: 1 }}>
                Tổng số công việc được giao mới trong tháng (Công việc)
              </TableCell>
              <TableCell align='center' colSpan={9} sx={{ border: 1 }}>
                Tổng số công việc phải làm trong tháng (Công việc)
              </TableCell>
              <TableCell align='center' colSpan={9} sx={{ border: 1 }}>
                Tổng số công việc có hạn hoàn thành trong tháng (Công việc)
              </TableCell>
              <TableCell align='center' colSpan={9} sx={{ border: 1 }}>
                Tổng số công việc trễ hạn trong tháng (Công việc)
              </TableCell>
            </TableRow>
            <TableRow>
