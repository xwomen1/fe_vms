...
const UserDetails = () => {
    ...
    const fetchRegions = async () => {
      try {
        const response = await axios.get(
          'https://dev-ivi.basesystem.one/smc/infrares/api/v0/regions/children-lv1/children/code?parentCode=level'
        )
  ...
  useEffect(() => {
    const fetchRegions = async () => {
      try {
        const response = await axios.get(
          'https://dev-ivi.basesystem.one/smc/infrares/api/v0/regions/children-lv1/children/code?parentCode=contracttype'
        )
  ...
  useEffect(() => {
    const fetchGroupData = async () => {
      try {
        ...
        const response = await axios.get(
          'https://dev-ivi.basesystem.one/smc/infrares/api/v0/regions/children-lv1/children/code?parentCode=company',
