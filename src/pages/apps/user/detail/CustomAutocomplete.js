...
const CustomAutocomplete = ({ groupOptions, defaultGroup, handleGroupChange, valueGroup, handleFilterGroup }) => {
  return (
    <FormControl fullWidth>
      <Autocomplete
        ...
        renderInput={params => <CustomTextField {...params} label='Group' />}
